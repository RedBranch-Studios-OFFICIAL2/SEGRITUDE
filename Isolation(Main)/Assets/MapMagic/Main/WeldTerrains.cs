...
namespace MapMagic
{
	...
	public class WeldTerrains
	{
		...
		public static void WeldToPrevX (ref float[,] heights, Terrain neig, int margin)
		{
			...
			var nStrip = neig.terrainData.GetHeights(heightSize-1,0,1,heightSize);
		...
		public static void WeldToNextX (ref float[,] heights, Terrain neig, int margin)
		{
			...
			var nStrip = neig.terrainData.GetHeights(0,0,1,heightSize);
		...
		public static void WeldToPrevZ (ref float[,] heights, Terrain neig, int margin)
		{
			...
			var nStrip = neig.terrainData.GetHeights(0,heightSize-1,heightSize,1);
		...
		public static void WeldToNextZ (ref float[,] heights, Terrain neig, int margin)
		{
			...
			var nStrip = neig.terrainData.GetHeights(0,0,heightSize,1);
		...
		public static void WeldSplatToNextX (ref float[,,] splats, Terrain neig, int margin)
		{
			...
			var nStrip = neig.terrainData.GetAlphamaps(0,0,1,splatsSize);
		...
		public static void WeldSplatToPrevZ (ref float[,,] splats, Terrain neig, int margin)
		{
			...
			var nStrip = neig.terrainData.GetAlphamaps(0,splatsSize-1,splatsSize,1);
		...
		public static void WeldSplatToNextZ (ref float[,,] splats, Terrain neig, int margin)
		{
			...
			var nStrip = neig.terrainData.GetAlphamaps(0,0,splatsSize,1);
		...
		public static void WeldTextureToPrevX (Texture2D texture, Texture2D neig) //TODO: margin is 1 now
		{
			...
			var nStrip = neig.GetPixels(splatsSize-1,0,1,splatsSize);
		...
		{
			int splatsSize = texture.width;
			var nStrip = neig.GetPixels(0,0,1,splatsSize);
		...
		public static void WeldTextureToPrevZ (Texture2D texture, Texture2D neig)
		{
			...
			var nStrip = neig.GetPixels(0,splatsSize-1,splatsSize,1);
		...
		{
			int splatsSize = texture.height;
			var nStrip = neig.GetPixels(0,0,splatsSize,1);
		...
		public static void WeldHeights (float[,] heights, Terrain prevX, Terrain nextZ, Terrain nextX, Terrain prevZ, int margin)
		{
			...
			{
				var nStrip = prevX.terrainData.GetHeights(heightSize-1,0,1,heightSize);
			...
			{
				var nStrip = nextX.terrainData.GetHeights(0,0,1,heightSize);
			...
			{
				var nStrip = prevZ.terrainData.GetHeights(0,heightSize-1,heightSize,1);
			...
			{
				var nStrip = nextZ.terrainData.GetHeights(0,0,heightSize,1);
		...
		public static void WeldSplats (float[,,] splats, Terrain prevX, Terrain nextZ, Terrain nextX, Terrain prevZ, int margin)
		{
			...
			{
				var nStrip = prevX.terrainData.GetAlphamaps(splatsSize-1,0,1,splatsSize);
			...
			{
				var nStrip = nextX.terrainData.GetAlphamaps(0,0,1,splatsSize);
			...
			{
				var nStrip = prevZ.terrainData.GetAlphamaps(0,splatsSize-1,splatsSize,1);
			...
			{
				var nStrip = nextZ.terrainData.GetAlphamaps(0,0,splatsSize,1);
		...
		public static void WeldTexture (Texture2D texture, Texture2D prevX, Texture2D nextZ, Texture2D nextX, Texture2D prevZ, int margin)
		{
			...
			{
				var nStrip = prevX.GetPixels(splatsSize-1,0,1,splatsSize);
			...
			{
				var nStrip = nextX.GetPixels(0,0,1,splatsSize);
				texture.SetPixels(splatsSize-1,0,1,splatsSize, nStrip);
			}
			...
			{
				var nStrip = prevZ.GetPixels(0,splatsSize-1,splatsSize,1);
				texture.SetPixels(0,0,splatsSize,1, nStrip);
			}
			...
			{
				var nStrip = nextZ.GetPixels(0,0,splatsSize,1);
				texture.SetPixels(0,splatsSize-1,splatsSize,1, nStrip);
			}
